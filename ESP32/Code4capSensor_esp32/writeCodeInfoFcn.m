% Autogenerated file: Wed May 31 12:19:54 2023
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("Code4capSensor",pwd) ;
...
skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'Code4capSensor.h';
    func_Initialize_Prototype.SourceFile = 'Code4capSensor.c';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'Code4capSensor_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate_Prototype.HeaderFile = 'Code4capSensor.h';
    func_OutputUpdate_Prototype.SourceFile = 'Code4capSensor.c';
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'Code4capSensor_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'Code4capSensor.h';
    func_Terminate_Prototype.SourceFile = 'Code4capSensor.c';
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['Code4capSensor_terminate'];
        codeInfo.TerminateFunctions =  [codeInfo.TerminateFunctions, func_Terminate_Interface'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_Code4capSensor_T';
        ...
        Var_RTModel = RTW.Variable(Ptrtype_RTModel_1_0.BaseType, 'Code4capSensor_M_');
        Var_RTModel.Owner           = 'Code4capSensor';
        Var_RTModel.DeclarationFile = 'Code4capSensor.h';
            Var_RTModel.DefinitionFile  = 'Code4capSensor.c';
        

        % Pointer Variable: PtrVar_RTModel
        PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'Code4capSensor_M', Var_RTModel);
