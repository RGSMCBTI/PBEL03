...
#                        of executable (1/0)?
MODEL                = Code4capSensor
MODULES              = Code4capSensor.c Code4capSensor_data.c ert_main.c rtiostream_tcp_esp32.c waijung2_hwdrvlib.c rt_main.c ext_svr.c updown.c ext_work.c mem_mgr.c rtiostream_utils.c
MODULES_OBJ          = Code4capSensor.obj Code4capSensor_data.obj ert_main.obj rtiostream_tcp_esp32.obj waijung2_hwdrvlib.obj rt_main.obj ext_svr.obj updown.obj ext_work.obj mem_mgr.obj rtiostream_utils.obj 
MAKEFILE             = Code4capSensor.mk
...
NUMST                = 1
NCSTATES             = 0
BUILDARGS            =  GENERATE_ASAP2=0 OPTS="-DEXT_MODE -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=2048 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
OPTIMIZATION_FLAGS   = 
ADDITIONAL_LDFLAGS   = 
COMPILER_COMMAND_FILE_NAME = Code4capSensor_comp.rsp

#--------------------------- Model and reference models -----------------------
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Code4capSensor_ref.rsp
...
%.o: $(subst ",,$(MATLAB_ROOT)/rtw/c/src/ext_mode/common)/%.cpp
	@echo ### Source $< done
...
%.o: $(subst ",,$(MATLAB_ROOT)/rtw/c/src/ext_mode/common)/%$(SRC_FILE_EXT)
	@echo ### Source $< done
